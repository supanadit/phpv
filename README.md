...
| Command | Description |
|---------|-------------|
| `phpv install <version>` | Install PHP with all dependencies |
| `phpv rebuild <version>` | Rebuild PHP with different extensions |
| `phpv use <version>` | Switch PHP version in current shell |
...
| `phpv uninstall <version>` | Remove PHP version and dependencies |
| `phpv upgrade [version]` | Upgrade to latest patch/minor version |
| `phpv doctor [version]` | Check system dependencies and extension readiness |
| `phpv extensions [--php 8.4]` | List available PHP extensions |
| `phpv validate-extensions <exts> --php 8.4` | Validate extension compatibility |
| `phpv phar install <name>` | Install PHAR tool (composer, pie, wp-cli) |
| `phpv phar update <name>` | Update PHAR tool |
| `phpv phar remove <name>` | Remove PHAR tool |
| `phpv phar which <name>` | Show path to installed PHAR |
| `phpv phar list` | List installed PHAR files |
| `phpv pecl install <archive>` | Install PECL extension from archive |
| `phpv pecl list` | List installed PECL extensions |
| `phpv pecl uninstall <name>` | Uninstall PECL extension |
...
| `phpv version` | Show phpv version |
...
| `--ext <names>` | Comma-separated extensions to enable |
