...
func GetLLVMVersionForPHP(phpVersion Version) LLVMVersion {
	...
	if phpVersion.Major == 8 {
		return LLVMVersion{
			Version:     "18.1.8",
			DownloadURL: "https://github.com/llvm/llvm-project/releases/download/llvmorg-18.1.8/LLVM-18.1.8-Linux-X64.tar.xz",
		}
	}
	...
	if phpVersion.Major == 7 && phpVersion.Minor == 4 {
		return LLVMVersion{
			Version:     "15.0.7",
			DownloadURL: "https://github.com/llvm/llvm-project/releases/download/llvmorg-15.0.7/LLVM-15.0.7-Linux-X64.tar.xz",
		}
	}
	...
	if phpVersion.Major == 7 {
		return LLVMVersion{
			Version:     "12.0.1",
			DownloadURL: "https://github.com/llvm/llvm-project/releases/download/llvmorg-12.0.1/LLVM-12.0.1-Linux-X64.tar.xz",
		}
	}
	...
	if phpVersion.Major == 5 {
		return LLVMVersion{
			Version:     "8.0.1",
			DownloadURL: "https://github.com/llvm/llvm-project/releases/download/llvmorg-8.0.1/LLVM-8.0.1-Linux-X64.tar.xz",
		}
	}
