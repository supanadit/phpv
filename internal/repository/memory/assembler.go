			...
			Constraints: []domain.VersionConstraint{
				{
					...
					Dependencies: []domain.Dependency{
						{Name: "openssl", Version: "3.3.2|>=3.0.0,<4.0.0"},
						{Name: "libxml2", Version: "2.12.7|~2.12.0"},
						{Name: "zlib", Version: "1.3.1|>=1.3.0"},
						{Name: "oniguruma", Version: "6.9.9|~6.9.0"},
						{Name: "curl", Version: "8.10.1|>=8.0.0"},
					},
				},
				{
					VersionRange: ">=8.0.0 <8.2.0",
					Dependencies: []domain.Dependency{
						{Name: "openssl", Version: "3.0.14|>=3.0.0,<3.1.0"},
						{Name: "libxml2", Version: "2.11.7|~2.11.0"},
						{Name: "zlib", Version: "1.3.1|>=1.3.0"},
						{Name: "oniguruma", Version: "6.9.9|~6.9.0"},
						{Name: "curl", Version: "8.10.1|>=8.0.0"},
					},
				...
				},
				{
					...
					Dependencies: []domain.Dependency{
						...
						{Name: "zlib", Version: "1.2.13|>=1.2.0,<1.3.0"},
						{Name: "oniguruma", Version: "5.9.6|~5.9.0"},
						{Name: "curl", Version: "7.12.1|>=7.12.0,<7.13.0"},
						{Name: "flex", Version: "2.5.39"},
						{Name: "bison", Version: "1.28"},
					},
				},
