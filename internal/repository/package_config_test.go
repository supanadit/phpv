...
func TestBuildRegistries_FromRanges(t *testing.T) {
	...
	want := []domain.Registry{
		{Name: "php", Source: "official", Version: "8.0.0", URL: "https://php.net/distributions/php-8.0.0.tar.gz"},
		{Name: "php", Source: "official", Version: "8.0.1", URL: "https://php.net/distributions/php-8.0.1.tar.gz"},
		{Name: "php", Source: "official", Version: "8.0.2", URL: "https://php.net/distributions/php-8.0.2.tar.gz"},
	}
...
func TestBuildRegistries_FromVersions(t *testing.T) {
	...
	got := BuildRegistries(cfg)
	want := []domain.Registry{
		{Name: "perl", Source: "source", Version: "5.22.3", URL: "https://cpan.org/src/5.0/perl-5.22.3.tar.gz"},
		{Name: "perl", Source: "source", Version: "5.20.0", URL: "https://cpan.org/src/5.0/perl-5.20.0.tar.gz"},
	}
	if !reflect.DeepEqual(got, want) {
...
func TestBuildRegistries_ExtensionOverride(t *testing.T) {
	...
	want := []domain.Registry{
		{Name: "perl", Source: "source", Version: "5.22.3", URL: "https://cpan.org/src/5.0/perl-5.22.3.tar.gz"},
		{Name: "perl", Source: "source", Version: "5.18.4", URL: "https://cpan.org/src/5.0/perl-5.18.4.tar.bz2"},
	}
	if !reflect.DeepEqual(got, want) {
