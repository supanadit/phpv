...
// ResolveRoot returns the phpv storage root. It reads PHPV_ROOT from the
// environment; when unset it falls back to $HOME/.phpv.
...
// ResolveCacheDir returns the download cache directory.
